...
export default function InboundDistrictPage() {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        ...
        // Filter packages for this district
        const filtered = data.find(
          (pkg) => pkg.category === "inbound" && pkg.district === district
        );
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative h-[50vh] flex items-center justify-center bg-[url('/assets/inbound-banner.jpg')] bg-cover bg-center">
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <p className="mt-3 text-lg">
            Explore the beauty, culture, and attractions of {formattedName}.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        {loading ? (
          ...
          <p className="text-gray-600">
            No attractions found for this district yet.
          </p>
        ) : (
